...
import com.syclo.sap.component.zaperam.bapi.Z_InboundDeliveryDocumentsFetchBAPI;
import com.syclo.sap.component.zaperam.object.Order;

/*This Step handler class is called by the  Z_InboundDeliveryDocumentsFetchSteplet class.
...
public class Z_InboundDeliveryDocumentsFetchStepHandler extends StepHandler {
	
	/*
	* Default Constructor definition for the class
	* */
	
	public Z_InboundDeliveryDocumentsFetchStepHandler() {
	}
	...
	* */
	...
	public Z_InboundDeliveryDocumentsFetchStepHandler(User user) {
		super(user);
	}

	/*
	 * This method will be used to invoke the BAPI class, Z_InboundDeliveryDocumentsFetchBAPI,
	...
	public Order[] getDocs() throws AgentryException {
		...
		try {
			...
			Z_InboundDeliveryDocumentsFetchBAPI bapi = (Z_InboundDeliveryDocumentsFetchBAPI) BAPIFactory.create(
					"Z_InboundDeliveryDocumentsFetchBAPI",
