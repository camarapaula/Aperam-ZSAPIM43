...
/*This Step handler class is called by the Z_MaterialNewAdhocCountingPostSteplet class.
...
public class Z_MaterialNewAdhocCountingPostStepHandler extends StepHandler {
	public Z_MaterialNewAdhocCountingPostStepHandler(User user) {
		super(user);
	}

	/*
	 * This method will be used to invoke the BAPI class, Z_AdhocMaterialCountPostBAPI,
