...
public class Z_PostPickingListsSteplet extends Steplet{
	public Z_PostPickingListsSteplet(TransactionSession session) throws AgentryException {
		super(session);
	}

	public Z_PostPickingListsSteplet(FetchSession session) throws AgentryException {
		super(session);
	}

	public Z_PostPickingListsSteplet(PushSession session) throws AgentryException {
		super(session);
	}

	/*
	 * This Execute method will be called from Agentry step and passes the control to 
	 * Z_PostPickingListsStepHandler class.This method is overridden from the Steplet class.
	 * */
	
	public boolean execute() throws AgentryException {
		try {
			Z_PostPickingListsStepHandler handler = (Z_PostPickingListsStepHandler) StepHandlerFactory.create(
					StepHandlerFactory.getClassName("Z_PostPickingListsStepHandler"), new Class[] { User.class },
